...
if __name__ == '__main__':
	...
	state = inspector.verify(signature=signature, pubkeyhash=pubkeyhash, msg=ffff)
	# print(state)
	...
	ffff2 = inspector.deserialize_have_P2WPKH(txhex2, amounts=["0046c32300000000"]) # "c37af31116d1b27caf68aae9e3ac82f1477929014d5b917657d0eb49478cb670"
	state2 = inspector.verify(signature=signature2, pubkeyhash=pubkeyhash2, msg=ffff2)
	# print(state2)
	...
	# assert
	state3 = inspector.verify(signature=signature3, pubkeyhash=pubkeyhash3, msg=ffff3[0])
	# print(state3)
